...
public class OutbreakPortalEntity extends Entity {
    ...
    public OutbreakPortalEntity(Level level, Player placer, Vec3 position) {
        ...
        outbreakSpawnSound();
        this.ownerUUID = placer.getUUID();
        this.spawnParticles = CobblemonOutbreaksConfig.SPAWN_PORTAL_PARTICLES;
    }
...
/*
    ...
    protected void addAdditionalSaveData(CompoundTag tag) {
        ...
        tag.putBoolean("spawnParticles", CobblemonOutbreaksConfig.SPAWN_PORTAL_PARTICLES);
